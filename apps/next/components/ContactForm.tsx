...
const ContactForm: FC = () => {
  ...
  return (
    <div className='bg-none font-xs text-black font-light'>
      {
       submitState === 'success' ? (
        ...
        <div>
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className='mb-5'>
              ...
              <input
                type='text'
                className='w-full border-b-[1px] outline-none focus:border-purple-500 focus:shadow-md'
            ...
            {submitState === 'error' && <p className="text-red-500">{errorMsg}</p>}
