  ...
  return (
    <div className="relative flex min-h-screen bg-gray p-0 lg:p-2">
      <main className="w-full h-full font-sans">
        ...
        <section className="relative bg-blue text-gray w-full p-6 md:p-6 gap-8
        ...
        </section>
        {
          ...
          <section className="relative w-full bg-gray text-dark-blue px-2 md:px-16 py-2 md:py-8 flex flex-col border-t-[1px] border-b-[1px]">
            ...
            <div className="w-full max-w-[500px] md:max-w-none mx-auto md:mx-0 flex flex-col items-center justify-around md:flex-row gap-8 my-6 ">
              {
        ...
        <section className="relative w-full min-h-[600px] bg-blue text-lite-orange flex flex-col md:flex-row justify-between gap-0 md:gap-8 p-6 lg:pl-16">
          <div className="w-fit mx-auto md:w-1/2">
            <h2 className="w-full mb-8 text-[40px] font-bold font-serif">{info.services.title}</h2> 
        ...
        <section className="relative w-full min-h-[600px] bg-gray text-black flex flex-col md:flex-row justify-between gap-8 p-6 lg:pl-16">
          <div className="relative w-full">
            <h2 className="w-full mb-8 text-[40px] font-serif font-bold">{info.howItWorks.title}</h2>
            <div className="w-full italic mb-8">
              <RichText value={info.howItWorks.body} />
            </div >
            <div className="relative w-full max-w-[500px] mx-auto lg:max-w-none h-auto flex flex-col lg:flex-row lg:justify-center gap-8 lg:items-start lg:justify-around">
              {
                info.howItWorks.parts &&
                info.howItWorks.parts.map((part: Part, idx: number) => (
                  <div className="relative w-auto md:w-[380px] md:min-h-[450px] flex flex-col lg:flex-row gap-4 lg:gap-8" key={`part ${idx}`}>
